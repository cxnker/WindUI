-- WINDUI UNIFICADA CON ICONOS OPTIMIZADOS
-- (Copia todo este código en un solo archivo)

-- ============================================
-- MÓDULO DE ICONOS (versión optimizada)
-- ============================================
local Icons = {
...
local IconModule = {
    IconsType = "lucide",
    DefaultIcon = "rbxassetid://110786993356448" -- icono "x" como fallback
}
...
function IconModule.Icon(iconName)
    -- Versión simplificada: solo usamos lucide
    local assetId = Icons[iconName]
    
    if assetId then
        return { assetId, {} }
    else
        warn("[IconModule] Icono '" .. tostring(iconName) .. "' no encontrado. Usando icono por defecto.")
        return { IconModule.DefaultIcon, {} }
    end
end

-- ============================================
-- AQUÍ VA TODO EL CÓDIGO DE WindUi_1.6.4.lua
-- ============================================
-- (Copia todo el contenido de WindUi_1.6.4.lua AQUÍ, desde "local a a={cache={}}..." hasta el final)

-- PERO ANTES de copiar WindUi_1.6.4.lua, necesitas modificar UNA SOLA LÍNEA:
-- Busca esta línea en el código original:
-- local g=loadstring(game:HttpGetAsync"https://raw.githubusercontent.com/Footagesus/Icons/main/Main.lua")()
-- Y REEMPLÁZALA con:
local g = IconModule  -- Usamos nuestro módulo de iconos local

-- Luego continúa con el resto del código de WindUi_1.6.4.lua...
